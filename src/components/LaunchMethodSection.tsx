      ...
      <div className="container text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {steps.map((step, index) => (
            ...
            >
              <div className="absolute -top-6 left-1/2 -translate-x-1/2 bg-primary text-white rounded-full h-12 w-12 flex items-center justify-center text-xl font-bold shadow-lg">
                {step.number}
              </div>
              <div className="mt-8">
