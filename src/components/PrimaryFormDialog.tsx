...
const PrimaryFormDialog = ({ setOpen }: { setOpen: (open: boolean) => void }) => {
  ...
  const handleCheckboxChange = (value: string, checked: boolean, field: "addOnInterests" | "primaryGoals") => {
    handleChange(
      field,
      checked
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setFormData({
      ...
      primaryGoals: [], otherPrimaryGoal: "", timeline: "", additionalDetails: "", // Removed contactMethod and preferredTime
      consent: false,
    });
  };
