...
const addOnsOptions = [
  ...
  { category: "Digital Foundation Services", subcategory: "Website & Online Presence", id: "seo-optimization-addon", label: "SEO Optimization ($499)", serviceId: "seo-optimization" },
  { category: "Digital Foundation Services", subcategory: "Social Media & Marketing", id: "social-media-5-posts", label: "Social Media Content: 5 Posts/Month ($199)", serviceId: "social-media-5-posts" },
  { category: "Digital Foundation Services", subcategory: "Social Media & Marketing", id: "social-media-10-posts", label: "Social Media Content: 10 Posts/Month ($349)", serviceId: "social-media-10-posts" },
  { category: "Digital Foundation Services", subcategory: "Social Media & Marketing", id: "social-media-15-posts", label: "Social Media Content: 15 Posts/Month ($649)", serviceId: "social-media-15-posts" },
  { category: "Digital Foundation Services", subcategory: "Social Media & Marketing", id: "email-system-setup", label: "Email System Setup ($499)", serviceId: "email-systems" },

  // Operations & Management Services
  { category: "Operations & Management Services", subcategory: "Business Systems", id: "analytics-google-setup", label: "Analytics & Reporting (Google Analytics setup) ($699)", serviceId: "analytics" },
  ...
  { category: "Operations & Management Services", subcategory: "Platform & Integration Services", id: "custom-automations-3-plus", label: "Custom Automations: For 3 Automations ($299)", serviceId: "custom-automations" },
  ...
  { category: "Operations & Management Services", subcategory: "Business Systems", id: "time-tracking-setup", label: "Time Tracking ($499)", serviceId: "time-tracking" },

  // Human Resources Services
  { category: "Human Resources Services", subcategory: "HR Foundation", id: "hr-legal-compliance", label: "Legal & Compliance ($499)", serviceId: "legal-compliance" },
  { category: "Human Resources Services", subcategory: "HR Foundation", id: "hr-recruiting-hiring", label: "Recruiting & Hiring ($599)", serviceId: "recruiting-hiring" },
  { category: "Human Resources Services", subcategory: "HR Foundation", id: "hr-operations-payroll", label: "HR Operations & Payroll ($799)", serviceId: "hr-operations-payroll" },
  { category: "Human Resources Services", subcategory: "HR Foundation", id: "hr-foundation-package", label: "HR Foundation ($1,249)", serviceId: "hr-foundation" },
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="flex items-center space-x-2 p-3 rounded-2xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 cursor-pointer hover:shadow-md hover:border-primary transition-all duration-300">
                      <Checkbox
                        ...
                        checked={formData.primaryGoals.includes("Legal & Compliance")}
                        onCheckedChange={(checked) => handleCheckboxChange("Legal & Compliance", checked as boolean, "primaryGoals")}
                      />
                      <Label htmlFor="goal-hr-legal-compliance">Legal & Compliance</Label>
                    </div>
                    <div className="flex items-center space-x-2 p-3 rounded-2xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 cursor-pointer hover:shadow-md hover:border-primary transition-all duration-300">
                      <Checkbox
                        id="goal-recruiting-hiring"
                        checked={formData.primaryGoals.includes("Recruiting & Hiring")}
                        onCheckedChange={(checked) => handleCheckboxChange("Recruiting & Hiring", checked as boolean, "primaryGoals")}
                      />
                      <Label htmlFor="goal-recruiting-hiring">Recruiting & Hiring</Label>
                    </div>
                    <div className="flex items-center space-x-2 p-3 rounded-2xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 cursor-pointer hover:shadow-md hover:border-primary transition-all duration-300">
                      <Checkbox
                    ...
                    <div className="flex items-center space-x-2 p-3 rounded-2xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 cursor-pointer hover:shadow-md hover:border-primary transition-all duration-300">
                      <Checkbox
                        id="goal-hr-foundation"
                        checked={formData.primaryGoals.includes("HR Foundation")}
                        onCheckedChange={(checked) => handleCheckboxChange("HR Foundation", checked as boolean, "primaryGoals")}
                      />
                      <Label htmlFor="goal-hr-foundation">HR Foundation</Label>
                    </div>
                    <div className="flex items-center space-x-2 p-3 rounded-2xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 cursor-pointer hover:shadow-md hover:border-primary transition-all duration-300">
                      <Checkbox
                        id="goal-other"
