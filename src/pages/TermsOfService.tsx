      ...
      <main className="flex-grow container py-16 md:py-24">
        <section className="text-center mb-16 animate-fade-in-up">
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300 max-w-4xl mx-auto leading-relaxed delay-200">
            Welcome to Calpir. By accessing or using our services, you agree to be bound by these Terms of Service. Please read them carefully.
          </p>
        </section>
        ...
        <div className="max-w-4xl mx-auto bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 animate-fade-in-up delay-300 text-gray-800 dark:text-gray-200">
          ...
          <p className="mb-4">
            If you have any questions about these Terms, please contact us at <a href="mailto:hello@calpirsolutions.com" className="text-primary hover:underline">hello@calpirsolutions.com</a>.
          </p>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-8 italic">
            ...
            <br />
            **Disclaimer:** This is a template. Please consult with a legal professional to draft Terms of Service specific to your business.
          </p>
        </div>
      </main>
      <Footer />
